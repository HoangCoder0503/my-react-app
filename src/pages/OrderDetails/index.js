                    ...
                    <form method="post">
                        {
                            orderDetails.items?.map((item, index) => (
                                <div key={index} className="cart-item row">
                                    ...
                                    <div className="cart-price col-lg-3 col-md-3 col-sm-12"><b>{formatPrice(item.qty * item.price)}</b>
                                    </div>
                                </div>
                            ))
                        }
                        ...
                        <div className="row">
                            ...
                            <div className="cart-price col-lg-3 col-md-3 col-sm-12"><b>{formatPrice(orderDetails.totalPrice)}</b></div>
                        </div>
                    </form>
                </div>
                {/*	End Order Details	*/}
